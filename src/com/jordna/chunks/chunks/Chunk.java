...
public class Chunk
{
    ...
    public boolean addMember(Player player) // Return TRUE if player was added, return FALSE if player is already
					    // trusted
    {
    ...
    public boolean addTrusted(Player player) // Return TRUE if player was added, return FALSE if player is already
					     // trusted
    {
	if (trusted.contains(player.getUniqueId().toString())) return false;
