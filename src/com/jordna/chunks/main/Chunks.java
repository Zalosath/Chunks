...
public class Chunks extends JavaPlugin
{
    ...
    private File chunkFile, chunksFile, startChestFile, lootTableFile, settingsFile, uuidFile;
    private FileConfiguration chunk, chunks, startChest, lootTable, settings, uuid;
	...
	this.addItemStackDefault(this.startChest, "chunks.start-chest.items",
	...
	this.addItemStackDefault(this.startChest, "chunks.start-chest.items",
		new ItemStack(Material.CHICKEN_SPAWN_EGG, 2));
	this.addItemStackDefault(this.startChest, "chunks.start-chest.items",
		new ItemStack(Material.SHEEP_SPAWN_EGG, 2));
	...
	this.addItemStackDefault(this.lootTable, "chunks.loot-table.items",
